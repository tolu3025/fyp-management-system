...
<div style="margin-bottom: 2rem; display: flex; justify-content: space-between; align-items: center;">
    <div>
        <h1 style="font-size: 1.75rem; font-weight: 700; color: var(--bg-dark);">Register Project Title</h1>
        <p style="color: var(--text-muted); font-size: 0.875rem;">Register your final year project title after aligning with your supervisor</p>
    </div>
    <a href="student_dashboard.php" class="btn btn-secondary">⬅ Back to Dashboard</a>
</div>
...
<div class="card" style="max-width: 600px; margin: 0 auto 2rem auto;">
    ...
    <div class="card-body">
        <div style="background-color: var(--bg-light); border: 1px solid var(--border); border-radius: var(--radius-sm); padding: 1rem; margin-bottom: 1.5rem;">
            <span style="font-size: 0.8rem; color: var(--text-muted); font-weight: 600; text-transform: uppercase; display: block;">Assigned Supervisor</span>
        ...
        <form action="student_project.php" method="POST" autocomplete="off">
            <div class="form-group">
                <label for="Tajuk_Projek" class="form-label">Project Title (Tajuk Projek)</label>
